...
class ProceduresInjections: NSObject, NSApplicationDelegate, NSWindowDelegate {
	...
	func processInjections() -> [String] {
		...
		let injVerbiageList = ["Decadron 4 mg/1 ml + Kenalog 40 mg/1 ml \(dkSiteView.titleOfSelectedItem!)", "PPD (Purified Protein Derivative) Mantoux TB Skin Test 0.1 ml/5 TU \(ppdSiteView.titleOfSelectedItem!)", "Celestone 6 mg/1 ml \(cSiteView.titleOfSelectedItem!)", "Flu shot: \(vaccineType) 0.5 ml \(fluSiteView.titleOfSelectedItem!)", "Solumedrol 125 mg \(solSiteView.titleOfSelectedItem!)", "Pneumovax 23: 0.5 ml \(pnvSiteView.titleOfSelectedItem!)", "B12 1000 mcg/1 ml \(b12SiteView.titleOfSelectedItem!)", "Tdap 0.5 ml \(tdapSiteView.titleOfSelectedItem!)", "Phenergan 25 mg \(phSiteView.titleOfSelectedItem!)", "Nubain 10 mg + Phenergan 25 mg \(nphSiteView.titleOfSelectedItem!)", "Toradol (Ketoralac) \(torDose) mg \(torSiteView.titleOfSelectedItem!)", "Rocephin \(rocDose) Lidocaine \(rocSiteView.titleOfSelectedItem!)", "Testosterone Cypionate 200 mg/1 ml \(tstSiteView.titleOfSelectedItem!)", "DepoProvera 150 mg/1 ml \(depoSiteView.titleOfSelectedItem!)", "Estradiol Cypionate 5 mg/1ml \(estSiteView.titleOfSelectedItem!)", "Procrit/Epogen 10,000 u \(epoSiteView.titleOfSelectedItem!)"]
